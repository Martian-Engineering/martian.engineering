...
/**
 * Calculates optimal popover placement relative to its trigger element based on available viewport space.
 */
export function calculate(
  ...
  const popoverRect = popoverElement?.getBoundingClientRect() ?? null;
