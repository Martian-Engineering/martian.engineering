...
export default function ClientsSection({
  ...
  const selectedClientData = selectedClient
    ? (clientsById.get(selectedClient) ?? null)
    : null;
  ...
  return (
    <div
      id="clients-section"
      className={pageStyles.gridContainer}
                      ...
                      <Card style={{ marginTop: "1rem" }}>
                        ...
                        >
                          ...
                          <span
                            style={{
                              color:
                                "var(--theme-text-header, var(--color-red-80))",
                                ...
                                {client.resources.map((resource, index) => {
                                  ...
                                  if (typeof resource === "string") {
                                    try {
                                      ...
                                      displayText = urlObj.hostname.replace(
                                        "www.",
                                        "",
                                      );
                                    } catch (e) {
                    ...
                    {clients.map((client) => (
                      <ActionListItem
                        ...
                        style={{
                          ...
                          fontWeight:
                            selectedClient === client.id ? "bold" : "normal",
